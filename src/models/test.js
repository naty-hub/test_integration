...
console.log(item1.isContentValid())

const toDoList1 = new ToDoList('ToDoList rafik', [item1, item2, item3, item4, item5, item6, item7, item8]);
...
console.log(toDoList1.additem(item8))

toDoList1.additem(item9)
//console.log(item4)
console.log(rafik)
